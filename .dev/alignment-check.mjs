 ...
 *
 *   WP_URL=https://colorlibhub.com/unioncorp node .dev/alignment-check.mjs
 *   UNIONCORP_PATHS=/,/contact/ WP_URL=… node .dev/alignment-check.mjs
 */

import { chromium } from 'playwright';

const base = ( process.env.WP_URL || 'http://127.0.0.1:9481' ).replace( /\/$/, '' );
const paths = ( process.env.UNIONCORP_PATHS || '/,/about/,/services/,/work/,/pricing/,/contact/,/blog/' ).split( ',' );
