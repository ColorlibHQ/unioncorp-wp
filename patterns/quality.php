...
<h2 class="wp-block-heading has-text-align-left has-overlay-color has-text-color">Quality makes the belief for customers</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"overlay"} -->
<p class="has-overlay-color has-text-color">Advice you can check: every recommendation comes with the workings, the assumptions and what would have to be true for it to be wrong.</p>
<!-- /wp:paragraph -->
