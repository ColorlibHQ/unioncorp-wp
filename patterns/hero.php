...
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/bg_1.avif' ) ); ?>","dimRatio":60,"overlayColor":"dark","isUserOverlayColor":true,"minHeight":70,"minHeightUnit":"vh","align":"full","layout":{"type":"constrained"}} -->
...
<p class="has-text-align-left unioncorp-eyebrow has-primary-color has-text-color has-small-font-size">Finance &amp; consultation</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1,"style":{"typography":{"textAlign":"left"}},"textColor":"overlay","fontSize":"colossal"} -->
<h1 class="wp-block-heading has-text-align-left has-overlay-color has-text-color has-colossal-font-size">We're always here to give financial help</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"textAlign":"left"}},"textColor":"overlay","fontSize":"large"} -->
<p class="has-text-align-left has-overlay-color has-text-color has-large-font-size">Planning, investment and risk management for businesses that would rather spend their time on the business.</p>
<!-- /wp:paragraph -->
